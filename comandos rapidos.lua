...
python main.py generate --model model/bookstore/author.py
python main.py generate --model model/bookstore/book.py  
python main.py generate --model model/bookstore/loan.py  
#------------------------------------------------------------------------



http://localhost:5000/api/options/authors?search=
